...
AFRICASTALKING = {
    "SMS_AFRICASTALKING_USER": os.getenv("SMS_AFRICASTALKING_USER", "healthtoolsAPI"),
    "SMS_AFRICASTALKING_KEY": os.getenv("SMS_AFRICASTALKING_KEY", '2875c45d0b660118cacb640f0efb1541c80f2fc1b5fcba4ee2cbf1f943ae6cf9'),
}
