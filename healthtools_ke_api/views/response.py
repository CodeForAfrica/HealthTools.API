...
KEYWORDS = {
                ...
                "nurses": ['nurse', 'no', 'nursing officer',
                        'mhuguzi', 'muuguzi', 'RN', 'Registered Nurse'],
                "clinical-officers":['CO', 'clinical officer',
                        'clinic officer', 'clinical', 'clinical oficer'],
                "NHIF": ['nhif', 'bima', 'insurance',
                        'insurance fund', 'health insurance', 'hospital fund'],
                "HF": ['hf', 'hospital', 'dispensary', 'clinic',
...
class BuildQuery(object):
    ...
    def check_for_keywords(self, query):
        word = query.split(' ')
