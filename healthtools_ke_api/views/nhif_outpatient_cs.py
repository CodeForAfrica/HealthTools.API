...
nhif_outpatientcs_api = Blueprint('nhif_outpatientcs_api', __name__)

@nhif_outpatientcs_api.route('/', methods=['GET'])
def index():
    '''
    Landing endpoint
    '''
...
@nhif_outpatientcs_api.route('/search.json', methods=['GET'])
def search():
    try:
