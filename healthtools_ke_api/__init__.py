...
from healthtools_ke_api.views.nhif_outpatient_cs import nhif_outpatientcs_api
...
app.register_blueprint(nhif_outpatientcs_api, url_prefix='/nhif-outpatientcs')
